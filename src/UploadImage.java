...
public class UploadImage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			if (formItems != null && formItems.size() > 0) {
				...
				for (FileItem item : formItems) {
					...
					if (!item.isFormField()) {
						...
						String htmBody = createBody(TMatch.processImage(filePath, getServletContext().getRealPath("")));
		 ...
		 * request.getParameterValues(paramName); // Read single valued data if
		 * (paramValues.length == 1) { String paramValue = paramValues[0]; if
		 * (paramValue.length() == 0) System.out.println("<i>No Value</i>");
		 * else System.out.println("paramValue " + paramValue); } else { // Read
		 * multiple valued data System.out.println("<ul>"); for (int i = 0; i <
		 * paramValues.length; i++) { System.out.println("<li>" +
		 * paramValues[i]); } System.out.println("</ul>"); } } paramNames =
		 ...
		 * "Reading Checkbox Data"; String docType =
		 * "<!doctype html public \"-//w3c//dtd html 4.0 " +
		 * "transitional//en\">\n";
		 * 
	...
	protected String createBody(List<String> imglist) {
		...
		String DivTmplt =		
				...
				+ "                            <img src=\"INC_images/__imageName\" alt=\"\"  />" 
		...
		String tmp = "<!DOCTYPE html>" + "<html lang=\"en\">" + "  <head>" + "    <meta charset=\"utf-8\">"
				...
				+ "                        <li class=\"active\"><a href=\"dragUpload.html\">TEMPLATE</a></li>"
				+ "                        <li><a href=\"gabor.html\">TEXTURE</a></li>"
