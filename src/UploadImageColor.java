 ...
 */
@WebServlet("/UploadImageColor")
public class UploadImageColor extends HttpServlet {
	...
	private static final String UPLOAD_DIRECTORY = "imageColor";

	/**
	 * Default constructor.
	 */
	public UploadImageColor() {
			...
			if (formItems != null && formItems.size() > 0) {
				...
				for (FileItem item : formItems) {
					...
					if (!item.isFormField()) {
						...
						String htmBody = createBody(colorBased.processImage(filePath, getServletContext().getRealPath("")));
	...
	protected String createBody(List<String> imglist) {	
		...
		String DivTmplt =		
				...
				+ "                            <img src=\"colorData/__imageName\" alt=\"\"  />" 
